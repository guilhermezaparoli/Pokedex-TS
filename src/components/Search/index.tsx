        ...
        <TypeSearch>
          ...
          <Types>
            <CardType
              ...
              onClick={() => handleCardTypeClick(0)}
            />
            <CardType
              value="flying"
              isSelected={isSelected[1]}
              onClick={() => handleCardTypeClick(1)}
            />
            <CardType
              value="bug"
              isSelected={isSelected[2]}
              onClick={() => handleCardTypeClick(2)}
            />
            <CardType
              value="dark"
              isSelected={isSelected[3]}
              onClick={() => handleCardTypeClick(3)}
            />
            <CardType
              value="dragon"
              isSelected={isSelected[4]}
              onClick={() => handleCardTypeClick(4)}
            />
            <CardType
              value="electric"
              isSelected={isSelected[5]}
              onClick={() => handleCardTypeClick(5)}
            />
            <CardType
              value="grass"
              isSelected={isSelected[6]}
              onClick={() => handleCardTypeClick(6)}
            />
            <CardType
              value="poison"
              isSelected={isSelected[7]}
              onClick={() => handleCardTypeClick(7)}
            />
            <CardType
              value="fairy"
              isSelected={isSelected[8]}
              onClick={() => handleCardTypeClick(8)}
            />
            <CardType
              value="fighting"
              isSelected={isSelected[9]}
              onClick={() => handleCardTypeClick(9)}
            />
            <CardType
              value="ghost"
              isSelected={isSelected[10]}
              onClick={() => handleCardTypeClick(10)}
            />
            <CardType
              value="ground"
              isSelected={isSelected[11]}
              onClick={() => handleCardTypeClick(11)}
            />
            <CardType
              value="ice"
              isSelected={isSelected[12]}
              onClick={() => handleCardTypeClick(12)}
            />
            <CardType
              value="normal"
              isSelected={isSelected[13]}
              onClick={() => handleCardTypeClick(13)}
            />
            <CardType
              value="psychic"
              isSelected={isSelected[14]}
              onClick={() => handleCardTypeClick(14)}
            />
            <CardType
              value="rock"
              isSelected={isSelected[15]}
              onClick={() => handleCardTypeClick(15)}
            />
            <CardType
              value="steel"
              isSelected={isSelected[16]}
              onClick={() => handleCardTypeClick(16)}
            />
            <CardType
              value="water"
              isSelected={isSelected[17]}
              onClick={() => handleCardTypeClick(17)}
            />
          </Types>
        </TypeSearch>
      </SearchContainer>
